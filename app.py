...
# =============================================================================
# COMPREHENSIVE NGRA & SAFETY DICTIONARY KEY INJECTOR (WITH SARA PoD)
# =============================================================================
def _ensure_safety_keys(res: dict) -> dict:
    if not isinstance(res, dict):
        res = {}
...
def calculate_ngra_mos(*args, **kwargs):
    """Calculates NGRA Margin of Safety (MoS) guaranteeing SARA_PoD_ug_cm2 and all UI keys."""
    try:
        ...
        sara_pod = float(res.get('SARA_PoD_ug_cm2', res.get('sara_pod_ug_cm2', 25.0)))
...
# =============================================================================
# EXPLICIT KEAP1 INTERACTION PLOT DEFINITION (TOP OF FILE)
# =============================================================================
...
class BayesianWoEEngine:
    ...
    def compute_posterior(res: dict, prior: float = 0.5) -> dict:
        ...
        call = "SENSITISER (Cat 1)" if posterior_prob >= 0.5 else "NON-SENSITISER (No Cat)"
...
def evaluate_oecd497_decision_trees(res: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "ITS_Call": ghs_cat,
        "ITS_Potency_Call": ghs_cat,
        "ITS_Potency": ghs_cat,
        "GHS_Potency_Call": ghs_cat,
        "Potency_Call": ghs_cat,
